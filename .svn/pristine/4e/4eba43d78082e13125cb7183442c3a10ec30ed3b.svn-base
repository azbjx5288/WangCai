...
public class GetChildInfoBean
{
    ...
    private float parentMulti;
    private float parentAg;
    private float parentGa;
    ...
    public float getParentMulti() {
        return parentMulti;
    }

    public void setParentMulti(float parentMulti) {
        this.parentMulti = parentMulti;
    }

    public float getParentAg() {
        return parentAg;
    }

    public void setParentAg(float parentAg) {
        this.parentAg = parentAg;
    }

    public float getParentGa() {
        return parentGa;
    }
