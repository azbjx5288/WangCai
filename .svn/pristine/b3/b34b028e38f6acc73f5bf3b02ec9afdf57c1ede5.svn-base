    ...
    /*private void updatedUI(int from,int to) {
        ...
        if (platFromBalance != null) {
            ...
            if (from != -1) {
                ...
                platFunds.setText(String.format("%.4f", wangcaiApp.getUserCentre().getUserInfo().getAbalance()));
            }
        }
        ...
        if (platToBalance != null) {
            ...
            if (to != -1) {
                ...
                channelFunds.setText(String.format("%.4f", wangcaiApp.getUserCentre().getUserInfo().getAbalance()));
            }
        }
    }*/
