...
/**
 * Created by ACE-PC on 2018/05/12.
 * 游戏趋势图页面
 */
public class GameStickResultAdapter extends BaseAdapter {
    ...
    public void setData(ArrayList<LotteryCode> resultList, Method methodRecord, String issue) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (lottery.getSeriesId() == 4) { //快三
            ...
            holder.kuaileLayout.setVisibility(View.GONE);
    ...
    private void setKuaiLe8(CharSequence[] item, ViewHolder holder) {
        ...
        holder.pk10layout.setVisibility(View.GONE);
        holder.kuaisanLayout.setVisibility(View.GONE);
        holder.kuaileLayout.setVisibility(View.VISIBLE);
    ...
    static class ViewHolder {
        ...
        @BindView(R.id.kuaile_layout)
        LinearLayout kuaileLayout;
